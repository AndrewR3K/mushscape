# MushScape Open Source Repo Code of Conduct

MushScape is an open source project and we welcome contributions from all. To ensure that the MushScape community is a safe and welcoming place for all, we ask that all contributors and community members adhere to the following code of conduct:
...
This Code of Conduct applies within all project spaces, including the codebase, issue trackers, and documentation, as well as other spaces such as social media, conferences, and online or offline events where members of the project community are present.
